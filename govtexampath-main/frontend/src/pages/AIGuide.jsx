...
const AIGuide = () => {
  ...
  const handleFreeText = (text) => {
    ...
    if (lower.includes('salary') && (lower.includes('ias') || lower.includes('civil service'))) {
      addBotMessage(freeTextAnswers.salary_ias);
    } else if (lower.includes('prepare') && lower.includes('upsc')) {
      addBotMessage(freeTextAnswers.prepare_upsc);
    } else if (lower.includes('eligible') && lower.includes('ssc')) {
      addBotMessage(freeTextAnswers.ssc_cgl_eligible);
    } else if (lower.includes('best exam') || lower.includes('which exam')) {
    ...
    } else if (lower.includes('salary') && lower.includes('ssc')) {
      ...
      addBotMessage('I can help you with:\n\n- Exam recommendations based on your profile\n- Salary information for various posts\n- Eligibility details for specific exams\n- Preparation strategies\n\nTry asking something specific, or type "restart" to go through the guided flow again.');
    }
  };
