...
const pages = [
  ...
  },
  {
    ...
    description: 'Get personalized government exam recommendations based on your education, age, and interests. AI-powered career guidance for 200+ exams across UPSC, SSC, Banking, Railways, Defence, and more.',
    content: '<h1>AI Career Guide — Personalized Government Exam Recommendations</h1><p>Get personalized government exam recommendations using our AI-powered career guide. Our system covers 200+ exams across 16 categories to find the best match for your profile.</p><h2>How It Works</h2><ol><li>Enter your educational qualification (10th, 12th, Graduation, Post Graduation)</li><li>Provide your age, category (Gen/OBC/SC/ST/EWS), and preferences</li><li>Our AI analyses 200+ exams and recommends the best matches</li><li>View detailed exam information including eligibility, syllabus, salary, and dates</li></ol><h2>Exam Categories Covered</h2><ul><li>UPSC — Civil Services, NDA, CDS, ESE, CMS, CAPF</li><li>SSC — CGL, CHSL, MTS, GD Constable, CPO, Stenographer</li><li>Banking — IBPS PO/Clerk, SBI PO/Clerk, RBI Grade B, SEBI, NABARD</li><li>Railways — RRB NTPC, Group D, JE, ALP, RPF</li><li>Defence — NDA, CDS, AFCAT, Indian Navy, Indian Army, Coast Guard</li><li>State PSC — UPPSC, MPPSC, BPSC, RPSC, TSPSC, APPSC and more</li><li>Teaching — CTET, KVS, NVS, UGC NET, State TET</li><li>Police — SSC CPO, Delhi Police, State Police, CAPF</li><li>Insurance — LIC AAO, NICL AO, OICL AO, GIC</li><li>PSU — ONGC, BHEL, IOCL, NTPC, DRDO, ISRO</li><li>Regulatory Bodies — RBI, SEBI, NABARD, IRDAI, IBBI, PFRDA</li><li>Judiciary — State Judicial Services, District Judge exams</li><li>Healthcare — NEET MDS, AIIMS Nursing, ESIC</li><li>Postal — India Post PA/SA, Postman, GDS</li><li>Agriculture — ICAR NET, FCI, State Agriculture exams</li><li>Miscellaneous — NTA, GATE, and other national exams</li></ul><p>This tool requires JavaScript to function. Please enable JavaScript in your browser for the interactive AI career guide experience.</p>',
  },
  {
