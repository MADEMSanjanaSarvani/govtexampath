...
<li><Link to="/cut-off" className="text-sm text-gray-400 hover:text-white transition-colors">{t('cutOff')}</Link></li>
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="flex gap-2">
              ...
              />
              <button type="submit" aria-label="Subscribe" disabled={subLoading} className="px-3 py-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 rounded-lg transition-colors">
