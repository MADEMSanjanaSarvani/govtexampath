...
import { FiGrid, FiFileText, FiUsers, FiBell, FiArrowLeft, FiRefreshCw, FiCpu } from 'react-icons/fi';
...
const links = [
  ...
  { to: '/admin/auto-updater', icon: FiRefreshCw, label: 'Auto Updater' },
  { to: '/admin/architecture', icon: FiCpu, label: 'Architecture' },
];
