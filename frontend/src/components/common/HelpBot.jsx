        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-t-2xl px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <h3 className="text-white font-semibold text-sm">{t('helpBotTitle')}</h3>
              <span className="flex items-center gap-1">
                <span className="w-2 h-2 bg-green-400 rounded-full inline-block"></span>
                <span className="text-green-200 text-xs">{t('helpBotOnline')}</span>
              </span>
            </div>
            <button
          ...
          <div className="p-3 border-t border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder={t('helpBotPlaceholder')}
                aria-label={t('helpBotPlaceholder')}
                disabled={isTyping}
