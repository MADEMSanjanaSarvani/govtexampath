...
const SEO = ({ title, description, path, jsonLd }) => {
  ...
  const defaultDesc = 'AI-powered career guidance for government exam aspirants. Explore 190+ exams, check eligibility, get personalized recommendations, and access free preparation resources.';
