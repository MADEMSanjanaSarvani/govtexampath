    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center px-4">
        ...
        <div className="text-center max-w-md">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3">{t('notFoundPageDev')}</h1>
          <p className="text-gray-500 dark:text-gray-400 mb-6">
            {t('notFoundPageDevDesc')}
          </p>
          <div className="flex gap-3 justify-center">
            ...
            >
              <FiHome className="w-5 h-5" /> {t('home')}
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="text-center max-w-md">
        ...
        <div className="flex gap-3 justify-center flex-wrap">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 font-medium rounded-xl border border-gray-200 dark:border-gray-700 hover:border-primary-400 transition-all"
          >
            <FiArrowLeft className="w-5 h-5" /> {t('notFoundBrowse')}
          </Link>
        </div>
        <div className="mt-8 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">{t('notFoundLooking')}</p>
          <div className="flex flex-wrap gap-2 justify-center">
            <Link to="/ai-guide" className="text-sm text-primary-600 dark:text-primary-400 hover:underline">{t('careerGuide')}</Link>
            <span className="text-gray-300 dark:text-gray-600">|</span>
            <Link to="/eligibility-checker" className="text-sm text-primary-600 dark:text-primary-400 hover:underline">{t('eligibilityChecker')}</Link>
            <span className="text-gray-300 dark:text-gray-600">|</span>
            <Link to="/resources" className="text-sm text-primary-600 dark:text-primary-400 hover:underline">{t('notFoundResources')}</Link>
          </div>
        </div>
      </div>
    </div>
