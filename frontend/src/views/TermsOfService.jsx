    ...
    content: (
      <>
        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-2"><span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-purple-500 shrink-0" /><span><strong className="text-gray-900 dark:text-white">Exam Information Database:</strong> <span className="text-gray-600 dark:text-gray-300">Comprehensive details on 500+ government exams across 16 categories including UPSC, SSC, Banking, Railways, Defence, State PSC, Teaching, Police, Insurance, PSU, Regulatory Bodies, Judiciary, Healthcare, Postal, Agriculture, and more.</span></span></li>
