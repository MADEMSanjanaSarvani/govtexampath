...
const resourcesData = [
  { id: 1, title: 'UPSC CSE Prelims Syllabus & Study Guide', type: 'Notes', exam: 'UPSC CSE', category: 'UPSC', description: 'Official UPSC Civil Services Preliminary exam syllabus with comprehensive topic-wise study guide covering History, Geography, Polity, Economics, Environment, and Science.', pages: '450+ pages', fileUrl: 'https://upsc.gov.in/' },
  { id: 2, title: 'UPSC Previous Year Question Papers', type: 'PYQ', exam: 'UPSC CSE', category: 'UPSC', description: 'Official previous year question papers from UPSC for Civil Services Prelims and Mains with detailed topic-wise analysis.', pages: '300+ questions', fileUrl: 'https://upsc.gov.in/' },
  { id: 3, title: 'Indian Polity by M. Laxmikanth - Key Points', type: 'Notes', exam: 'UPSC / State PSC', category: 'UPSC', description: 'Chapter-wise summary notes from the most important book for Indian Polity preparation. Covers Constitution, governance, and political system.', pages: '120 pages', fileUrl: 'https://upsc.gov.in/' },
  { id: 4, title: 'UPSC Mains Essay & Answer Writing Guide', type: 'Notes', exam: 'UPSC CSE', category: 'UPSC', description: 'Proven frameworks for essay writing and GS answer structuring. Includes sample essays, model answers, and scoring techniques used by toppers.', pages: '200 pages', fileUrl: 'https://upsc.gov.in/' },
  ...
  { id: 8, title: 'Quantitative Aptitude for Competitive Exams', type: 'Books', exam: 'SSC / Banking', category: 'SSC', description: 'Recommended quantitative aptitude books and resources with shortcuts, tricks, and practice problems covering all topics for SSC and Banking exams.', pages: '600+ pages', fileUrl: '/resources' },
  ...
  { id: 22, title: 'NDA Exam Syllabus & Preparation Guide', type: 'Notes', exam: 'NDA', category: 'Defence', description: 'Comprehensive guide for NDA written exam covering Mathematics and General Ability Test with SSB interview preparation tips.', pages: '500 pages', fileUrl: 'https://upsc.gov.in/' },
  { id: 23, title: 'CDS Previous Year Papers with Solutions', type: 'PYQ', exam: 'CDS', category: 'Defence', description: 'Previous year CDS exam papers with detailed solutions for English, GK, and Mathematics sections from UPSC official archives.', pages: '250+ questions', fileUrl: 'https://upsc.gov.in/' },
  ...
  { id: 38, title: 'CAPF AC Previous Year Papers', type: 'PYQ', exam: 'UPSC CAPF', category: 'Police', description: 'Previous year question papers for UPSC CAPF Assistant Commandant exam with solutions for General Ability, Intelligence, and Essay papers.', pages: '150+ questions', fileUrl: 'https://upsc.gov.in/' },
  ...
  { id: 42, title: 'GATE Complete Notes (CS/ECE/ME)', type: 'Notes', exam: 'GATE', category: 'PSU', description: 'Subject-wise notes for GATE covering Data Structures, Algorithms, OS, DBMS, Networks, Signals & Systems, Thermodynamics, and more with previous year solutions.', pages: '600+ pages', fileUrl: 'https://gate.iitk.ac.in/' },
  { id: 43, title: 'GATE Previous Year Papers (All Branches)', type: 'PYQ', exam: 'GATE', category: 'PSU', description: 'Official GATE previous year question papers with answer keys for CS, ECE, ME, EE, CE, and other branches from IIT archives.', pages: '500+ questions', fileUrl: 'https://gate.iitk.ac.in/' },
  { id: 44, title: 'PSU Recruitment Through GATE Guide', type: 'Notes', exam: 'PSU via GATE', category: 'PSU', description: 'Complete guide for PSU recruitment through GATE — covers application process, cutoffs, interview preparation, and profiles of top PSUs like ONGC, IOCL, NTPC, BHEL, and GAIL.', pages: '200 pages', fileUrl: 'https://gate.iitk.ac.in/' },
  ...
  { id: 60, title: 'Best Books for Government Exams 2026', type: 'Books', exam: 'All Exams', category: 'UPSC', description: 'Curated list of must-read books for UPSC, SSC, Banking, and Railways with expert reviews and reading strategies.', pages: 'Book list', fileUrl: '/resources' },
