...
const resourcesData = [
  { id: 1, title: 'UPSC CSE Prelims Syllabus & Study Guide', type: 'Notes', exam: 'UPSC CSE', category: 'UPSC', description: 'Official UPSC Civil Services Preliminary exam syllabus with comprehensive topic-wise study guide covering History, Geography, Polity, Economics, Environment, and Science.', pages: '450+ pages', fileUrl: 'https://upsc.gov.in/examinations/civil-services-ias-exam' },
  { id: 2, title: 'UPSC Previous Year Question Papers', type: 'PYQ', exam: 'UPSC CSE', category: 'UPSC', description: 'Official previous year question papers from UPSC for Civil Services Prelims and Mains with detailed topic-wise analysis.', pages: '300+ questions', fileUrl: 'https://upsc.gov.in/examinations/previous-question-papers' },
  { id: 3, title: 'Indian Polity by M. Laxmikanth - Key Points', type: 'Notes', exam: 'UPSC / State PSC', category: 'UPSC', description: 'Chapter-wise summary notes from the most important book for Indian Polity preparation. Covers Constitution, governance, and political system.', pages: '120 pages', fileUrl: 'https://upsc.gov.in/examinations/civil-services-ias-exam' },
  { id: 4, title: 'UPSC Mains Essay & Answer Writing Guide', type: 'Notes', exam: 'UPSC CSE', category: 'UPSC', description: 'Proven frameworks for essay writing and GS answer structuring. Includes sample essays, model answers, and scoring techniques used by toppers.', pages: '200 pages', fileUrl: 'https://upsc.gov.in/examinations/civil-services-ias-exam' },
  { id: 5, title: 'NCERT Summary Notes (Class 6-12)', type: 'Notes', exam: 'UPSC / State PSC', category: 'UPSC', description: 'Concise chapter-wise summaries of all NCERT textbooks for History, Geography, Polity, Economics, and Science — the foundation of UPSC preparation.', pages: '350 pages', fileUrl: 'https://ncert.nic.in/textbook.php' },
  { id: 6, title: 'SSC CGL Exam Pattern & Syllabus Guide', type: 'Notes', exam: 'SSC CGL', category: 'SSC', description: 'All-in-one study material covering Quantitative Aptitude, English, Reasoning, and General Awareness for SSC CGL Tier I and Tier II.', pages: '500+ pages', fileUrl: 'https://ssc.gov.in/portal/CGL' },
  { id: 7, title: 'SSC CGL Previous Year Papers & Answer Keys', type: 'PYQ', exam: 'SSC CGL', category: 'SSC', description: 'Shift-wise previous year question papers with official answer keys and detailed solutions. Includes all shifts from recent years.', pages: '200+ papers', fileUrl: 'https://ssc.gov.in/portal/Answer-Key' },
  { id: 8, title: 'Quantitative Aptitude for Competitive Exams', type: 'Books', exam: 'SSC / Banking', category: 'SSC', description: 'Recommended quantitative aptitude books and resources with shortcuts, tricks, and practice problems covering all topics for SSC and Banking exams.', pages: '600+ pages', fileUrl: '/blog/best-books-for-upsc-preparation-2026' },
  { id: 9, title: 'SSC CHSL Syllabus & Preparation Guide', type: 'Notes', exam: 'SSC CHSL', category: 'SSC', description: 'Complete syllabus breakdown for SSC CHSL Tier I and descriptive paper. Includes section-wise weightage analysis and 60-day study plan.', pages: '250 pages', fileUrl: 'https://ssc.gov.in/portal/CHSL' },
  { id: 10, title: 'SSC MTS & GD Constable Combined Guide', type: 'Notes', exam: 'SSC MTS / GD', category: 'SSC', description: 'Joint preparation strategy for SSC MTS and GD Constable exams. Covers common syllabus areas, physical standards for GD, and previous year trends.', pages: '300 pages', fileUrl: 'https://ssc.gov.in/portal/MTS' },
  { id: 11, title: 'English Grammar & Vocabulary Master Guide', type: 'Notes', exam: 'All Exams', category: 'SSC', description: 'Complete English grammar and vocabulary guide with rules, examples, and practice questions for all competitive exams.', pages: '300 pages', fileUrl: 'https://ssc.gov.in/portal/CHSL' },
  { id: 12, title: 'Logical Reasoning & Analytical Ability', type: 'Notes', exam: 'All Exams', category: 'SSC', description: 'Master guide for reasoning section covering verbal, non-verbal, and analytical reasoning with shortcut methods.', pages: '350 pages', fileUrl: 'https://ssc.gov.in/portal/CGL' },
  ...
  { id: 14, title: 'Banking Awareness Complete Capsule 2026', type: 'Notes', exam: 'Banking Exams', category: 'Banking', description: 'Everything you need for banking awareness - RBI policies, banking terms, financial news, government schemes, and economic surveys.', pages: '150 pages', fileUrl: 'https://www.rbi.org.in/Scripts/Publications.aspx' },
  ...
  { id: 17, title: 'SBI PO Descriptive Paper Writing Guide', type: 'Notes', exam: 'SBI PO', category: 'Banking', description: 'Essay and letter writing templates for SBI PO Mains descriptive paper. Covers formal letters, essays on banking topics, and scoring patterns.', pages: '100 pages', fileUrl: 'https://www.sbi.co.in/web/careers' },
  ...
  { id: 22, title: 'NDA Exam Syllabus & Preparation Guide', type: 'Notes', exam: 'NDA', category: 'Defence', description: 'Comprehensive guide for NDA written exam covering Mathematics and General Ability Test with SSB interview preparation tips.', pages: '500 pages', fileUrl: 'https://upsc.gov.in/examinations/nda-na-exam' },
  { id: 23, title: 'CDS Previous Year Papers with Solutions', type: 'PYQ', exam: 'CDS', category: 'Defence', description: 'Previous year CDS exam papers with detailed solutions for English, GK, and Mathematics sections from UPSC official archives.', pages: '250+ questions', fileUrl: 'https://upsc.gov.in/examinations/previous-question-papers' },
  { id: 24, title: 'AFCAT Exam Guide & Practice Papers', type: 'Notes', exam: 'AFCAT', category: 'Defence', description: 'Complete guide for Air Force Common Admission Test covering General Awareness, Verbal Ability, Numerical Ability, and Reasoning with military aptitude tips.', pages: '300 pages', fileUrl: 'https://afcat.cdac.in/' },
  ...
  { id: 28, title: 'UPPSC PCS Previous Year Papers', type: 'PYQ', exam: 'UPPSC PCS', category: 'State PSC', description: 'Previous year Prelims and Mains question papers for UP PSC Provincial Civil Services with answer keys and detailed solutions.', pages: '200+ questions', fileUrl: 'https://uppsc.up.nic.in/' },
  ...
  { id: 35, title: 'SSC CPO Sub-Inspector Exam Guide', type: 'Notes', exam: 'SSC CPO', category: 'Police', description: 'Complete guide for SSC CPO Sub-Inspector exam covering Paper I syllabus, Paper II English, physical test standards, and medical norms.', pages: '350 pages', fileUrl: 'https://ssc.gov.in/portal/CPO' },
  { id: 36, title: 'SSC GD Constable Complete Guide', type: 'Notes', exam: 'SSC GD', category: 'Police', description: 'Complete preparation guide for SSC GD Constable covering all subjects, physical fitness standards, and medical requirements.', pages: '250 pages', fileUrl: 'https://ssc.gov.in/portal/GD' },
  { id: 37, title: 'Delhi Police SI & Constable Study Material', type: 'Notes', exam: 'Delhi Police', category: 'Police', description: 'Preparation notes for Delhi Police recruitment covering Reasoning, Quant, English, General Awareness, and Delhi-specific current affairs.', pages: '280 pages', fileUrl: 'https://delhipolice.gov.in/' },
  { id: 38, title: 'CAPF AC Previous Year Papers', type: 'PYQ', exam: 'UPSC CAPF', category: 'Police', description: 'Previous year question papers for UPSC CAPF Assistant Commandant exam with solutions for General Ability, Intelligence, and Essay papers.', pages: '150+ questions', fileUrl: 'https://upsc.gov.in/examinations/previous-question-papers' },
  { id: 39, title: 'LIC AAO Complete Preparation Material', type: 'Notes', exam: 'LIC AAO', category: 'Insurance', description: 'Comprehensive study material for LIC AAO exam covering Reasoning, Quant, English, GK, and Insurance Awareness.', pages: '300 pages', fileUrl: 'https://www.licindia.in/careers' },
  ...
  { id: 42, title: 'GATE Complete Notes (CS/ECE/ME)', type: 'Notes', exam: 'GATE', category: 'PSU', description: 'Subject-wise notes for GATE covering Data Structures, Algorithms, OS, DBMS, Networks, Signals & Systems, Thermodynamics, and more with previous year solutions.', pages: '600+ pages', fileUrl: 'https://gate2026.iitb.ac.in/' },
  { id: 43, title: 'GATE Previous Year Papers (All Branches)', type: 'PYQ', exam: 'GATE', category: 'PSU', description: 'Official GATE previous year question papers with answer keys for CS, ECE, ME, EE, CE, and other branches from IIT archives.', pages: '500+ questions', fileUrl: 'https://gate2026.iitb.ac.in/' },
  { id: 44, title: 'PSU Recruitment Through GATE Guide', type: 'Notes', exam: 'PSU via GATE', category: 'PSU', description: 'Complete guide for PSU recruitment through GATE — covers application process, cutoffs, interview preparation, and profiles of top PSUs like ONGC, IOCL, NTPC, BHEL, and GAIL.', pages: '200 pages', fileUrl: 'https://gate2026.iitb.ac.in/' },
  ...
  { id: 53, title: 'NEET PG Subject-Wise Notes', type: 'Notes', exam: 'NEET PG', category: 'Healthcare', description: 'High-yield notes for NEET PG covering all 19 subjects — Anatomy, Physiology, Biochemistry, Pathology, Pharmacology, Medicine, Surgery, OBG, Pediatrics, and more.', pages: '700+ pages', fileUrl: 'https://nbe.edu.in/' },
  { id: 54, title: 'FMGE/MCI Screening Test Guide', type: 'Notes', exam: 'FMGE', category: 'Healthcare', description: 'Preparation guide for Foreign Medical Graduate Examination covering all clinical and pre-clinical subjects with previous year analysis.', pages: '400 pages', fileUrl: 'https://nbe.edu.in/' },
  ...
  { id: 60, title: 'Best Books for Government Exams 2026', type: 'Books', exam: 'All Exams', category: 'UPSC', description: 'Curated list of must-read books for UPSC, SSC, Banking, and Railways with expert reviews and reading strategies.', pages: 'Book list', fileUrl: '/blog/best-books-for-upsc-preparation-2026' },
