...
import { FiSearch, FiExternalLink, FiCheckCircle, FiClock, FiAlertCircle, FiX, FiChevronDown, FiTarget, FiAlertTriangle, FiHelpCircle, FiChevronRight } from 'react-icons/fi';
              ...
              >
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <Link
                      to={`/exams/${exam._id}`}
                      className="flex-1 flex items-center justify-center gap-1 px-3 py-2 text-sm font-medium text-white bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl shadow-sm hover:shadow-md transition-all"
                    >
                      Exam Details
