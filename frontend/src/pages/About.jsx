    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">125+ Exam Coverage</h3>
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none mb-12">
        ...
        <h2>Our Story</h2>
        <p>
          GovtExamPath started as a passion project by a team of government exam enthusiasts who saw firsthand how confusing the landscape of government exams can be. With 125+ exams across 15+ categories, each with different eligibility criteria, age limits, and reservation rules, aspirants often spend weeks just figuring out which exams they can apply for.
        </p>
        <p>
