...
const sections = [
  ...
  },
  {
    number: 3,
    icon: FiCpu,
    title: 'AI Career Guide Disclaimer',
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Our AI-powered Career Guide provides personalized exam recommendations based on the information you provide (age, education, preferences, etc.). Please understand that:
        </p>
        <ul className="mt-3 space-y-2">
          {[
            <>AI recommendations are generated by algorithms and are <strong className="text-gray-900 dark:text-white">suggestions only</strong>, not professional career counseling or advice.</>,
            'The AI system may not account for all individual circumstances, recent policy changes, or specific state-level variations.',
