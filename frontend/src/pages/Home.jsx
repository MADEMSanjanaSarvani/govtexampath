...
const stats = [
  ...
  { value: '125+', label: 'Government Exams' },
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'GovtExamPath is India\'s free career guidance platform for government jobs. It offers AI-powered exam recommendations, an eligibility checker, syllabus mind maps, and free preparation resources for 125+ government exams including UPSC, SSC, Banking, Railways, and Defence.',
      },
    },
    {
      '@type': 'Question',
...
const Home = () => {
  ...
  return (
    <div className="overflow-hidden">
      <SEO path="/" description="India's free career guidance platform for government jobs. Explore 125+ exams like UPSC, SSC, Banking, Railways. Get AI career guide, eligibility checker, syllabus mind maps, and free resources." jsonLd={faqSchema} />
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-blue-100/90 mb-10 max-w-2xl mx-auto leading-relaxed">
              Discover 125+ government exams, check your eligibility instantly, get AI-powered career guidance, and access free preparation resources. All in one place, completely free.
            </p>
